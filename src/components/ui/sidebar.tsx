    ...
    return (
      <div
        ...
        className={cn(
          ...
          "min-w-0 max-w-[var(--sidebar-width)]",
          className
        )}
        {...props}
      >
    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          "w-[var(--sidebar-width)] min-w-0 max-w-[100vw]",
          side === "left"
